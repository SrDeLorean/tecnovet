...
$route['editarPerfil'] = 'administrador/editarPerfil';
$route['mascota'] = 'administrador/mascota';
$route['editarMascota'] = 'administrador/editarMascota';
$route['dueno'] = 'administrador/dueno';
$route['editarDueno'] = 'administrador/editarDueno';
$route['estado'] = 'administrador/estado';
$route['editarEstado'] = 'administrador/editarEstado';
$route['caracter'] = 'administrador/caracter';
$route['editarCaracter'] = 'administrador/editarCaracter';
$route['sexo'] = 'administrador/sexo';
$route['editarSexo'] = 'administrador/editarSexo';
$route['especie'] = 'administrador/especie';
$route['editarEspecie'] = 'administrador/editarEspecie';
...
$route['editarTratamiento'] = 'administrador/editarTratamiento';
$route['hospitalizacion'] = 'administrador/hospitalizacion';
$route['editarHospitalizacion'] = 'administrador/editarHospitalizacion';
$route['consulta'] = 'administrador/consulta';
$route['editarConsulta'] = 'administrador/editarConsulta';
$route['visita'] = 'administrador/visita';
$route['editarVisita'] = 'administrador/editarVisita';
