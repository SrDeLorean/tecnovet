...
class Mascota extends CI_Model {
  ...
  /**
    ...
    $this->db->select("mascota_id, usuario_nombre , mascota_nombre, especie_nombre, raza_nombre, sexo_nombre, mascota_fechaNacimiento, mascota_color,mascota_microchip, mascota_foto,caracter_nombre, estado_nombre, mascota_esterilizacion, mascota_creacion, mascota_actualizacion");
